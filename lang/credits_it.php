...
'err_no_credits' => 'Non avete credito sufficente.<br/>Il pagamento ammonta a %s che corrisponde a %s credito ed avete solo %s credito',
...
Possedete ora %s credito.
	 
Vi é stato accreditao da %s credito a %s.
Adesso possediete %s credito.
